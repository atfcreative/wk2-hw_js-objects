...
var bird = {
	name: "Tweety",
	noise: "I thought I saw a puddy tat!",
	makeNoise: function () {
		console.log(this.noise);
	}
...
var mouse = {
	...
	noise: "The fastest mouse in all Mexico!",
	makeNoise: function () {
		console.log(this.noise);
	}
...
Take a look at the index.html file. You'll notice the following code:
	...
	<img src="images/bird.jpg" alt="bird photo" />
	<img src="images/cat.jpg" alt="cat photo" />
	<img src="images/dog.jpg" alt="dog photo /
	<img src="images/mouse.jpg" alt="mouse photo" />
...
for (var i = 0; i < animals.length; i++ ) {
	animals[i].appear = function() {
		document.querySelector('img').setAttribute('src', 'images/' + dog.name + '.jpg');
	};
}
